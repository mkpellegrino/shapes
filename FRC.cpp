...
Prism::Prism( Coordinate * C1, Coordinate * C2, int c=0)
{
#ifdef DEBUG
...
int main()
{
  ...
  Line * Floor = new Line( new Coordinate( -15, -14, 0 ), new Coordinate( 20, -14, 0 ));
  Coll->add( Floor );

  
  Ellipse * Wheel = new Ellipse( new Coordinate( 3.75, -12, 0 ), 2, 2 );
  Wheel->setColour(0);
  Coll->add( Wheel );

  Ellipse * Wheel2 = new Ellipse( new Coordinate( 14.25, -12, 0 ), 2, 2 );
  Wheel2->setColour(0);
  Coll->add( Wheel2 );

  Rectangle * Base = new Rectangle( new Coordinate( -1, -12.25, 0 ), new Coordinate( 19, -9.25, 0 ));
  Base->setColour( 2 );
  Coll->add( Base );

  Rectangle * Platform = new Rectangle( new Coordinate( -15, -14, 0), new Coordinate( -2, -11, 0 ));
  Platform->setColour( 0 );
  Coll->add( Platform );

  Rectangle * Leg1 = new Rectangle( new Coordinate( 18.5, 4, 0 ), new Coordinate( 18.75, -12, 0));
  Coll->add( Leg1 ); // Leg1 in UP position

  Rectangle * Leg2 = new Rectangle( new Coordinate( 5.5, 4, 0 ), new Coordinate( 5.25, -12, 0));
  Coll->add( Leg2 ); // Leg1 in UP position


  Leg1->translate( 0,-2,0); // Drop Leg 1
  Leg2->translate( 0,-2,0); // Drop Leg 2
  
  Leg2->translate( 0,8.25,0); // Raise Leg 2 a little
  Base->translate( 0,13, 0 );
  Wheel->translate( 0,13, 0 );
  Wheel2->translate( 0,13, 0 );
  ...
  Leg1->rotate( 32, new Coordinate( 18.67, -14, 0 ));  
  Leg2->rotate( 32, new Coordinate( 18.67, -14, 0 ));  
  Base->rotate( 32, new Coordinate( 18.67, -14, 0 ));
  Wheel->rotate( 32, new Coordinate( 18.67, -14, 0 ));
  Wheel2->rotate( 32, new Coordinate( 18.67, -14, 0 ));
